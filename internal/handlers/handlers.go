...
func (m *Repository) PostReservation(w http.ResponseWriter, r *http.Request) {
	...
	if !ok {
		helpers.ServerError(w, errors.New("cannot fetch reservation from session"))
		return
	}
	...
	htmlMessage = fmt.Sprintf(`
		...
		Reservation has been made for %s from %s to %s.
...
func (m *Repository) PostAvailability(w http.ResponseWriter, r *http.Request) {
	...
	m.App.Session.Put(r.Context(), "reservation", res)
	render.Template(w, r, "choose-room.page.go.tmpl", &models.TemplateData{
		Data: data,
	})
}
...
// ReservationSummary displays the reservation summary list
...
func (m *Repository) ShowLogin(w http.ResponseWriter, r *http.Request) {
	render.Template(w, r, "login.page.go.tmpl", &models.TemplateData{
		Form: forms.New(nil),
	})
}
...
func (m *Repository) AdminDashboard(w http.ResponseWriter, r *http.Request) {
	render.Template(w, r, "admin-dashboard.page.go.tmpl", &models.TemplateData{})
}

// AdminNewReservations show all new reservations in admin tool
func (m *Repository) AdminNewReservations(w http.ResponseWriter, r *http.Request) {
	...
	render.Template(w, r, "admin-new-reservations.page.go.tmpl", &models.TemplateData{
		Data: data,
	})
}

// AdminReservations show all reservations in admin tool
func (m *Repository) AdminAllReservations(w http.ResponseWriter, r *http.Request) {
	...
	data := make(map[string]any)
	data["reservations"] = reservations
	render.Template(w, r, "admin-all-reservations.page.go.tmpl", &models.TemplateData{
		Data: data,
	})
}
...
func (m *Repository) AdminPostReservationsCalendar(w http.ResponseWriter, r *http.Request) {
	...
	form := forms.New(r.PostForm)
	for _, x := range rooms {
		// Get the block map from the session. Loop through entire map, if we an entry in the map
	...
	m.App.Session.Put(r.Context(), "flash", "Changes saved")
	redirect_url := fmt.Sprintf("/admin/reservations-calendar?y=%d&m=%d", year, month)
